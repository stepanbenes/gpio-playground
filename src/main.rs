...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let pwm0 = Pwm::with_frequency(Channel::Pwm0, 100.0, 0.51, Polarity::Normal, false)?;
    let pwm1 = Pwm::with_frequency(Channel::Pwm1, 100.0, 0.51, Polarity::Normal, false)?;
